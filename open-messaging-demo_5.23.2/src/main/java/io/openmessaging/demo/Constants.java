...
public class Constants {
	...
	//commitlog文件最大长度
	public static final long COMMITLOG_FILE_MAX_LENGTH = 1024*1024*512;	//TODO update 5.23
	//comiitlog文件最大可写长度，当超出该长度时，申请新的commitlog文件
	public static final long COMMITLOG_FILE_MAX_WRITE_LENGTH = 1024*1024*510;//TODO update 5.23
	//commitqueue文件夹名
	 ...
	 * 5.4添加
	 */
	public static final int COMMIT_LOG_FILE_OFFSET_BYTES = 29; 	//offset中在文件中的位置所占位数，与COMMITLOG_FILE_MAX_LENGTH对应
	public static final int COMMIT_LOG_FILE_OFFSET_PLACEHOLDER = 0x1FFFFFFF;//offset取与操作，得到单个文件内的offset
	/**
	 * 5.5添加
	 */
	public static final int COMMIT_QUEUE_READ_DOZEN = 1000; //读取commitqueue，读取多个long后就进行readcommitlog
	/**
	 * 5.6添加
	 */
	...
	public static final int ONCE_WRITE_DOZEN = 400;		//TODO 一个生产者一次写入的消息条数 500
	
	/**
	 * 5.9添加
	 */
	public static final int UPDATE_COMMIT_QUEUE_BUFFER_LENGTH = COMMIT_QUEUE_READ_DOZEN*8*1000;	//commitqueue 一次更新使用的长度
