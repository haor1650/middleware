...
public class Constants {
    public final static String STORE_PATH = "temp";//System.getProperty("store.path", "/tmp");
    ...
    public final static int PRO_MAX = Integer.valueOf(System.getProperty("pro.max","300000"));
