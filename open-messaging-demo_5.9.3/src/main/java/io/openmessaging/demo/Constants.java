...
public class Constants {
	...
	//commitqueue文件最大长度
	public static final long COMMITQUEUE_FILE_MAX_LENGTH = 1024*1024*300;	//TODO test
	 ...
	 * 5.6添加
	 */
	public static final int WORKING_PRODUCER_NUM_LIMIT = 1;	//同时允许工作的生产者数量
	/**
	 * 5.8添加
	 */
	public static final int MSG_BLOCKING_QUEUE_LENGTH = 100;
	public static final int ONCE_WRITE_DOZEN = 100;		//一个生产者一次写入的消息条数
